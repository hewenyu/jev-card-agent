...
export const POKER_FEATURE_CONTRACT = 'visible-poker-facts-v4';
...
export function createPokerDomain(options: {
  ...
  return {
    ...
    featureBuilderVersion: 'visible-facts-priced-actions-session-v4',
    knowledgeUpdaterVersion: 'immutable-hand-facts-v1',
    continuationVersion: 'same-release-current-visible-state-session-v2',
    features: {
    ...
    context: {
      ...
      continuation:
        'Each subsequent decision uses updated visible state, prior hand-local decision statuses and choices, and the same strategy release and frozen historical facts for this hand. Session starts at turn 1 with no previous choices; current or future choices are never included.',
